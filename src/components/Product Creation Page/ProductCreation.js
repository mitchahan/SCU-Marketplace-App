              ...
              <div className="content">
                <div className="form">
                  ...
                  <div className="form-group">
                    ...
                    <input type="hidden"/>
                    <textarea name="description" cols="40" rows="5" placeholder="Write a description about the product here" value = {this.state.description} onChange={this.handleChange}></textarea>
                  </div>
                  <div className="form-group">
                    <label htmlFor="Image URL">ImageURL</label>
                    <input type="photo" name="photo" placeholder="Image URL" value = {this.state.photo} onChange={this.handleChange}/>
                  </div>
              </div>
            </div>
